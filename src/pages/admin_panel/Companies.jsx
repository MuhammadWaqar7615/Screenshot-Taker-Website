...
import Sidebar from "../../components/Sidebar";
import { FaEdit, FaTrash, FaUpload, FaSignOutAlt } from "react-icons/fa";
import { IoClose } from "react-icons/io5";
...
export default function Companies() {
  ...
  <div className="relative">
    ...
    >
      ...
      {/* Dropdown Icon - Exactly like previous pages */}
      <svg 
    ...
    {showLogoutDropdown && (
      <div className="absolute right-0 top-12 mt-1 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
          ...
          <button
            onClick={openAddModal}
            className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg shadow transition-colors cursor-pointer disabled:opacity-50"
            disabled={saving || loading}
          >
            ➕ Add Company
          </button>
                ...
                {filteredCompanies.map((company, idx) => (
                  ...
                  >
                    ...
                    <td className="p-3 flex gap-3">
                      <button
                        onClick={() => openEditModal(company)}
                        className="text-yellow-400 hover:text-yellow-200 transition-colors p-1 rounded disabled:opacity-50"
                        disabled={saving}
                        title="Edit company"
                      >
                        <FaEdit size={16} />
                      ...
                      <button
                        onClick={() => handleDelete(company.id)}
                        className="text-red-500 hover:text-red-300 transition-colors p-1 rounded disabled:opacity-50"
                        disabled={saving}
                        title="Delete company"
                      >
                        <FaTrash size={16} />
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-md relative border border-gray-700">
              <button
                onClick={closeModal}
                className="absolute top-3 right-3 text-gray-400 hover:text-white cursor-pointer transition-colors p-1 rounded-full hover:bg-gray-700 disabled:opacity-50"
                disabled={saving}
              >
                <IoClose size={24} />
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter company name"
                    required
                    className="w-full border border-gray-600 rounded-lg px-3 py-2 bg-gray-900 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-colors disabled:opacity-50"
                    disabled={saving}
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={3}
                    className="w-full border border-gray-600 rounded-lg px-3 py-2 bg-gray-900 text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-colors resize-none disabled:opacity-50"
                    disabled={saving}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4"> 
                    {formData.logoPreview ? (
                      <div className="relative">
                        ...
                        <button
                          type="button"
                          onClick={removeLogo}
                          className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs hover:bg-red-600 transition-colors disabled:opacity-50"
                          disabled={saving}
                        >
                          ×
                        </button>
                    ...
                    <button
                      type="button"
                      onClick={triggerFileInput}
                      className="flex items-center gap-2 px-4 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors text-sm disabled:opacity-50"
                      disabled={saving}
                    >
                      <FaUpload size={14} />
                      {formData.logoPreview ? "Change Logo" : "Upload Logo"}
